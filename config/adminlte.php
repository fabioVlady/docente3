...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Facultades',
            'route'  => 'admin.facultads.index',
            'icon' => 'fas fa-briefcase fa-fw',
            'can'        => 'admin.facultads.index',
            'active' => ['admin/facultads*']
        ],
        [
            'text' => 'Carreras',
        ...
        ['header' => 'DOCENTE',
            'can' => 'admin.curso_idiomas.index'   
        ],
        [
            'text' => 'Cursos Idiomas',
            'route'  => 'admin.curso_idiomas.index',
            'icon' => 'fas fa-user-friends fa-fw',
            'can'  => 'admin.curso_idiomas.index',
            'active' => ['admin/curso_idiomas*']
        ],
        [
            'text' => 'Cursos Extras',
            'route'  => 'admin.curso_extras.index',
            'icon' => 'far fa-folder fa-fw',
            'can'  => 'admin.curso_extras.index',
            'active' => ['admin/curso_extras*']
        ],
        [
        ...
        [
            ...
            'route'  => 'admin.formacions.index',
            'can'  => 'admin.formacions.index',
            'icon' => 'fas fa-user-graduate fa-fw',
            'active' => ['admin/formacions*']
        ],
        [
            'text' => 'Experiencia Laboral',
            'route'  => 'admin.experiencias.index',
            'icon' => 'fas fa-briefcase fa-fw',
            'can'  => 'admin.experiencias.index',
            'active' => ['admin/experiencias*']
        ],
        [
            'text' => 'Materias Dictadas',
            'route'  => 'admin.docente_materia.index',
            'icon' => 'fas fa-briefcase fa-fw',
            'can'  => 'admin.docente_materia.index',
            'active' => ['admin/docente_materia*']
        ],
        [
            'text' => 'Plan y Cronograma',
            'url'  => 'admin/eventos',
            'icon' => 'fas fa-briefcase fa-fw',
        ...
        [
            'text' => 'Reporte Docentes',
            'route' => 'admin.repoDocentes',
